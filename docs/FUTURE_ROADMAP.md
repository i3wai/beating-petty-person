...
2. **「值得付錢嗎？」** → 免費版足夠好到讓人驚訝。$2.99 是衝動消費。Apple Pay / Google Pay 一鍵付款。Stripe 信任標章 + 退款保證消除疑慮（Day 13 已加）
   - **問題（2026-04-15 診斷）**：$2.99 reading 只有純文字，無視覺產物、無儀式感。$4.99 證書是 CSS 排版不能下載。「強化密封動畫」是虛假宣傳（免費用戶看到同樣的 3s 動畫）。三個 tier 各自交付都不值那個價。
   - **改善計畫**：見 `process.md` → Active Task: Paid Tier Product Upgrade
