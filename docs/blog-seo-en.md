...
|---|------|------|---------|--------|-----|------|--------|
| B4 | `/blog/what-is-black-magic` | **支柱** | what is black magic, black magic, is black magic real, black magic spells | 2,900 + 22,200 + 1,900 + 1,300 | 60 | ~4,000 | 6-8 |
| B2 | `/blog/how-to-curse-someone` | 輻條 | how to curse someone, how to curse people, how to curse a person | 1,300 + 590 + 480 | 25 | ~4,000 | 4-5 |
| B7 | `/blog/hex-spells-curses` | 輻條 | hexes, hexing, how to hex someone, hex spell, hex spells | 1,900 + 1,600 + 880 + 590 + 480 | 25-33 | ~4,000 | 4-5 |
| B5 | `/blog/revenge-spells` | 輻條 | revenge spells, revenge spell, spells for revenge | 590 + 320 + ~200 | 24 | ~4,000 | 4-5 |
...
| # | Slug | 角色 | 主關鍵字 | 月搜量 | KD | 字數 | FAQ 數 |
|---|------|------|---------|--------|-----|------|--------|
| B8 | `/blog/how-to-get-rid-of-bad-luck` | **支柱** | how to get rid of bad luck, bad luck, how to remove bad luck | 1,000 + 3,600 + 480 | 23-55 | ~4,000 | 6-8 |
| B9 | `/blog/how-to-remove-a-curse` | 輻條 | how to remove a curse, signs of a curse, curse protection | 1,300 + 590 + 480 | ~30 | ~4,000 | 4-5 |
...
| # | Slug | 角色 | 主關鍵字 | 月搜量 | KD | 字數 | FAQ 數 |
|---|------|------|---------|--------|-----|------|--------|
| B6 | `/blog/voodoo-magic-curses` | **支柱** | voodoo magic, is voodoo demonic, voodoo hex | 1,600 + 480 + 210 | 41 | ~4,000 | 5-6 |
| B1 | `/blog/what-is-da-siu-yan` | 輻條 | villain hitting, Da Siu Yan, what is beating petty person | ~200 | <20 | ~4,000 | 3-4 |
| B3 | `/blog/history-of-villain-hitting` | 輻條 | Goose Neck Bridge Hong Kong, Jingzhe curse tradition | ~500 | <15 | ~4,000 | 3-4 |
...
[深度內容。每篇目標 ~4,000 字。支柱每個子主題 800-1,200 字，輻條每個子主題 600-1,000 字。]
...
| 天 | 文章 | 理由 |
|---|------|------|
| **Day 1 AM** | B2（如何詛咒，~4,000 字） | 最高商業意圖。KD25，單獨先發搶先機。 |
| **Day 1 PM** | B8（厄運支柱，~4,000 字） | 最高流量快速勝利（KD23）。內部連結從第一天就有效。 |
| **Day 2 AM** | B6（voodoo 支柱，~4,000 字） | KD19 精選摘要機會，最低競爭支柱 |
| **Day 2 PM** | B9（解除詛咒，~4,000 字） | 1,300 vol 缺口，恐懼驅動意圖 |
| **Day 3 AM** | B7（hex 法術，~4,000 字） | Cluster A 輻條，1,900+1,600 vol |
| **Day 3 PM** | B5（報復法術，~4,000 字） | Cluster A 輻條 |
| **Day 4 AM** | B1（打小人是什麼，~4,000 字） | Cluster C 輻條（品牌識別） |
| **Day 4 PM** | B3（打小人歷史，~4,000 字） | 完成 Cluster C |
| **Day 5** | B4（黑魔法支柱，~4,000 字） | 最高流量、最高 KD。最後發，由 8 篇輻條提供語義支持。 |

**節奏**：每天 2 篇，5 天完成。輻條先發，支柱最後。B2 第一篇單獨先發搶商業意圖。
