...
keywords: ["what is beating petty person", "villain hitting", "打小人", "Chinese folk curse", "Da Siu Yan", "Chinese folk magic"]
date: "2026-04-12"
cluster: "C"
...
faqs:
  ...
  - question: "What do you need for a villain hitting ritual?"
    answer: "The full traditional ceremony requires: incense and red candles (for invoking deities), a 百解符 hundred-solutions talisman (for registering the client's information), a paper effigy (for the target), an old shoe or slipper (for striking), a paper White Tiger figure with raw pork (for the sacrifice step), rice or five-color beans (for dispelling misfortune), red 貴人紙 noble-person paper and gold/silver paper money (for blessings), and 筊杯 divination blocks (for confirming completion). Shortened sessions at Goose Neck Bridge may omit some elements. The digital version at BeatPetty requires only a phone or computer."
---
...
The traditional Da Siu Yan ceremony follows **eight distinct steps** — the 八部曲 (eight movements) of Cantonese folk tradition. While shortened versions exist for quick sessions at Goose Neck Bridge, the full ceremony spans from inviting the gods to confirming the result with divination blocks. Every element has meaning. Every gesture serves a purpose. This is not improvised — it is a ceremony refined over centuries of practice.
...
### Step 1: 請神 — Inviting the Deities

The practitioner lights incense and red candles, calling upon heaven and earth to witness the ritual. This step establishes sacred space — without divine witnesses, the beating is just vandalism against paper. With them, it becomes judgment.

### Step 2: 稟告 — Declaration

The practitioner writes the **client's** name and birthdate on a 百解符 (hundred-solutions talisman), then writes the target's name on a paper effigy — a humanoid shape cut from ceremonial paper, typically yellow or white. If the target's exact name is unknown, a general curse can be directed at a category of petty person: the backstabber, the tyrant, the thief of fortune. If a photograph is available, it is attached to the figure.

Both the client and the target are formally registered — the complaint is now on the record with the spirit world. The more specific the identification, the more focused the curse. In traditional belief, the paper figure *becomes* the target through the act of naming — a principle shared across multiple [curse traditions worldwide](/blog/how-to-curse-someone).

### Step 3: 過火 — Passing Through Fire

The talisman and effigy are passed over the candle flames. This purification step uses fire to cleanse both documents, burning away anything that might weaken the ritual's focus. Not every practitioner lists this as a separate step — some fold it into the declaration — but it is commonly observed at Hong Kong's Goose Neck Bridge.

### Step 4: 打小人 — Striking the Petty Person

The core of the ceremony. The practitioner takes an old shoe — traditionally a worn slipper or cloth shoe — and beats the paper figure against a hard surface. Each strike is deliberate. Each blow lands with a sharp crack that echoes under the bridge.

As they strike, the practitioner recites curse chants. Traditional incantations follow specific patterns: naming the target's offenses, invoking the White Tiger spirit to devour the petty person's influence, and commanding the petty person to retreat. The words vary by practitioner and region, but the structure is consistent — identify the harm, invoke authority, command its end.
...
The physical destruction of the effigy mirrors the intended destruction of the petty person's influence. As the paper tears and crumples, so too does the petty person's power to harm.

### Step 5: 祭白虎 — White Tiger Sacrifice and Burning

The beaten effigy is placed into the mouth of a **paper White Tiger (紙白虎)**. Raw pork is offered to the tiger's mouth — feeding it so it devours the petty person, not the client. Then the paper tiger and effigy are **burned together**, reducing everything to ash.

The White Tiger is one of the [Four Symbols](https://en.wikipedia.org/wiki/Four_Symbols_(China)) in Chinese mythology — guardian of the west, associated with autumn, metal, and warfare. In the context of this ritual, the tiger is a devourer. The logic: 以凶制凶 — fight ferocity with ferocity. The tiger eats your enemy. Then fire consumes them both.

Not every session includes the full White Tiger ceremony. Short sessions at Goose Neck Bridge may simplify this to burning the effigy alone. But during Jingzhe, and for more serious grievances, the White Tiger sacrifice is considered essential — it ensures the curse has spiritual backing, not just human anger.

### Step 6: 化解 — Dispelling Misfortune

The practitioner scatters rice, five-color beans (五色豆), sesame seeds, and peanuts onto the ground. Each grain represents the petty person's retreat — scattering their influence in all directions, ensuring the misfortune they caused is dispersed rather than merely displaced. This step often involves the 百解符, now charged with the ritual's energy.

### Step 7: 祈福/進寶 — Praying for Blessings

The ceremony shifts from destruction to restoration. The practitioner uses red 貴人紙 (noble-person paper) to pray for helpful allies and good fortune to enter the client's life. Gold and silver paper money (金銀衣紙) and ingots (元寶) are burned as offerings to the spirits — payment for their assistance. The ritual moves from eliminating the negative to inviting the positive.

### Step 8: 擲筊 — Divination and Confirmation

The practitioner throws two crescent-shaped wooden blocks (筊杯) and observes how they land:

- **聖杯** (one face up, one face down) — The spirits confirm the ritual is complete. Success.
- **笑杯** (both faces up) — The spirits are amused but noncommittal. The outcome is uncertain.
- **怒杯** (both faces down) — The spirits reject the ritual. It may need to be repeated.

The divination provides closure — a definitive answer from the spirit world that the matter is settled. When the blocks fall right, the client walks away knowing the ritual succeeded.
