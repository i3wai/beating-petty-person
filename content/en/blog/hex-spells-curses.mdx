...
description: "What is a hex? Learn the difference between hex spells, curses, and jinxes — their origins in Pennsylvania Dutch folk magic, how hexing works, and what happens when you hex someone."
...
The word itself reveals its roots. "Hex" derives from the [German *hexe*](https://en.wikipedia.org/wiki/Hex_(witch)) — simply "witch." In Pennsylvania Dutch country, a *hex* was any spell cast by a practitioner of *Braucherei* (also called *Powwowing*), a system of folk healing and magic brought to America by German immigrants in the 17th and 18th centuries. Over time, the term narrowed in English usage to mean specifically harmful magic — a spell meant to do damage.
...
Instead of drawing symbols or tying knots, Chinese practitioners strike a paper effigy with a shoe — each blow transferring focused anger into the ritual. Instead of hex signs, they use paper figures bearing the target's name. Instead of candles, they use fire to consume the effigy entirely.
